...
(function() {
  var abc, posture, postureGraph, squared, thresholdDistance, thresholdExplore, transition,
  ...
  postureGraph = (function() {
    ...
    postureGraph.prototype.findDuplicates = function() {
      var n, nn, _i, _j, _len, _len1, _ref, _ref1;
      _ref = this.nodes;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        n = _ref[_i];
        if (n != null) {
  ...
  abc = (function() {
    ...
    abc.prototype.savePosture = function(configuration, body, upper_csl, lower_csl) {
      var bodyAngle_new_p, bodyAngle_p, expected_node, f, found, graph_func, lj, n, new_p, node_name, p, p_expect, parent, pp, uj;
      if (this.manual_noop) {
        return;
      }
      ...
      if (physics.upper_joint.position_controller_active && physics.lower_joint.position_controller_active && this.last_expected_node) {
        ...
        if (p.isClose(this.last_test_posture)) {
          ...
          this.switch_to_random_release_after_position(uj);
          this.switch_to_random_release_after_position(lj);
          this.last_posture = this.posture_graph.getNodeByName(node_name);
          this.last_test_posture = null;
          this.last_detected = null;
          return;
        }
    ...
    abc.prototype.newCSLMode = function() {
      ...
      dir_index_for_modes = function(start_mode, target_mode) {
        ...
        if ((s_h === t_h) || (__indexOf.call(s_h, "s") >= 0 && __indexOf.call(t_h, "c") >= 0) || (__indexOf.call(s_h, "c") >= 0 && __indexOf.call(t_h, "s") >= 0)) {
          a = s_k;
          b = t_k;
          i = 2;
        } else {
