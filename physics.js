...
(function() {
  ...
  var b2Body, b2BodyDef, b2CircleShape, b2Color, b2Fixture, b2FixtureDef, b2MassData, b2MouseJointDef, b2PolygonShape, b2RevoluteJointDef, b2Shape, b2Transform, b2Vec2, b2World, dt, physics, steps_per_frame,
      ...
      if ((this.run || this.step) && this.pend_style) {
        ...
        if (isMouseDown && (!mouseJoint)) {
          ...
          if (body && !(body === this.ground && this.pend_style === 3)) {
            ...
            this.ui.canvas_trans_x += mousePixelX - this.ui.canvas_old_x;
            this.ui.canvas_trans_y += mousePixelY - this.ui.canvas_old_y;
          }
        }
        if (mouseJoint) {
          if (isMouseDown) {
